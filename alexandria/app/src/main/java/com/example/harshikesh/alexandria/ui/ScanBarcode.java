...
import com.example.harshikesh.alexandria.CameraPreview.CameraPreview;
...
public class ScanBarcode extends AppCompatActivity {
    ...
    private void initControls() {
       // setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        ...
        if (null == mCamera){
            ...
            Snackbar.make(cameraContainer, getString(R.string.no_autofocus), Snackbar.LENGTH_LONG);
            onBackPressed();
        }
    ...
    public Camera getCameraInstance() {
        ...
        try {
            ...
            // emulator technically says it has a camera but none is present
            //Utilities.showAlertDialog(getString(R.string.no_camera),this);
            Snackbar.make(cameraContainer, getString(R.string.no_camera), Snackbar.LENGTH_LONG);
            onBackPressed();
